...
AuthorTabContainer:AddButton({Title = "Join Discord Server", Description = "Join the author's discord. To receive information or updates", Callback = function()
    ...
    setclipboard("Discord/gg.Mkklzz")
end})
...
local BasicSettingsToolDropdown = HomeTabContainer:AddDropdown("BasicSettingsToolSelection", {Title = "Select Tool Farm", Values = {}, Multi = false, Default = nil})
...
OthersTabContainer:AddButton({Title = "Teleport to Location [BETA]", Description = "Teleport to Selected Island", Callback = function()
    if AutomatedQuestFarmingEnabled or AutomatedMobBringingEnabled then
        PrimaryDashboardWindow:Dialog({Title = "MicaHub Information", Content = "Teleportation is disabled while Auto Farm Quests or Auto Bring Mobs is active. Please disable these features before teleporting to maintain farming stability.", Buttons = {
            {Title = "Ok", Callback = function() end}
        }})
        return
    end
